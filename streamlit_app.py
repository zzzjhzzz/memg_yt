...
# 자막 추출 함수들
# ---------------------------------
def fetch_via_yta_with_retry(video_id: str, langs: List[str], max_retries: int = 2) -> str:
    """재시도 로직이 포함된 YTA 자막 추출 (재시도 횟수 감소)"""
    last_error = None
